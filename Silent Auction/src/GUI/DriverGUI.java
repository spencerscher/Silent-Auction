...
public class DriverGUI {
	...
	public static void main(String[] args) {
		...
		Date d5 = new Date();
		Item item5 = new Item();
		item5.setName("Marefat's favorite pencil");
		item5.setDate(d5);
		item5.setValue(250.0f);
		...
		b1.setBidderMoney(450.0f);
		
		Bidder b2 = new Bidder();
		b2.setName("Nasser");
		b2.setPassword("123456");
		b2.setBidderMoney(495.0f);
		...
		// Run the silent auction GUI
		
		InterfaceGUI inter = new InterfaceGUI(sa1);
